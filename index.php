    ...
    <div class="page-header-content text-center">
      <div class="page-header wsub shift-down">
        <h1 class="page-title fadeInDown animated first">
          <img class="fullscreen-logo hide-logo-large" src="images/logo-cc-horizontal.jpeg"
            alt="Cicada Ceramics logo" />
        </h1>
      </div><!-- / page-header -->
      <p>
...
<section id="featured-products">
  ...
  <div id="products-carousel" class="owl-carousel">
    ...
    <div class="item product">
      ...
      <!-- / sale-label -->
      <a href="single-product.php?category=<?php echo $row['mainCategory'] ?>&product=<?php echo $row['id'] ?>&subcategory=%"
