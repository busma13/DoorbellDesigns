...
<!-- page title -->
<title>Doorbell Designs - Doorbells</title>
<!-- bootstrap css -->
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pulse animated">
                            ...
                            <li><a href="shop-filter.html?category=doorbells">Doorbells</a></li>
                            <li><a href="shop-filter.html?category=fan">Ceiling Fan Pulls</a></li>
                            <li><a href="shop-filter.html?category=artwork">Artwork</a></li>
                            <li><a href="custom-orders.html?category=custom">Custom Orders</a></li>
