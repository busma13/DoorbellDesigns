    ...
    <div id="page-header" class="faq">
        <div class="container">
            <div class="page-header-content text-center">
                ...
                <p class="slide-text fadeInUp animated second">Frequently Asked Questions</p>
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="panel-group tabbed">
                    <div class="panel">
                    <div class="panel-heading">
                        <a class="panel-title collapsed" data-toggle="collapse" href="#panel2">Guarantee</a>
                    </div>
                    <div id="panel2" class="panel-collapse collapse">
                        <div class="panel-body text-gray">
                            <p>We guarantee our products to be received in full working condition and undamaged. We cannot be held responsible for breakages of our products after receipt.</p>
                            <p>Buttons come with a one year warranty.</p>
                            <p>There are no returns on custom orders, however we will cover warranty issues stated in the first paragraph above.</p>
                            <p>We take great care to deliver digital imagery of custom products and receive approval and payment prior to shipping.</p>
                            <p>We take great pride in our custom work and want to always exceed your expectations.</p>
            ...
            <div class="col-sm-6">
                ...
                <div class="panel-group tabbed">
                    <div class="panel">
                    <div class="panel-heading">
                        <a class="panel-title collapsed" data-toggle="collapse" href="#panel7">How much will the delivery cost me?</a>
                    </div>
                ...
                <div class="panel-group tabbed">
                    <div class="panel">
                    <div class="panel-heading">
                        <a class="panel-title collapsed" data-toggle="collapse" href="#panel8">Are my payments secure?</a>
                    </div>
