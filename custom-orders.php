<?php
    ...
    $title = 'Doorbell Designs - Custom Orders';
    echo $title;
...
<section id="about">
    <div class="container">
        <div class="text-wrap">
            ...
            <p>The designs come in various shapes and sizes.</p>
            <p>If you need a particular size, you need to indicate that in your order.</p>
            <p>You should also state if you prefer either a regular rectangular shape or an odd shape.</p>
