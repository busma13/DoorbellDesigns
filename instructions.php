...
<section id="about">
    <div class="container">
        <div class="text-wrap">
            ...
            <p class="large-p"> Doorbells normally use 12 volts of electricity, so there is no need to turn off the electricity.
            Remove the old doorbell.
            Make sure there is enough room for the back of the new button and wires to fit back into the hole. If not,use a file or utility knife to enlarge the hole.
            Align decorative plate with wire hole and mark screw holes.
            Pre-drill holes for screws in wood or siding, or for anchors (Use a 3/16 masonry bit to a depth of 7/8") in stucco or brick walls.
            Attach wire leads to screw terminals on button.
            Attach plate to wall with screws. </p>
            ...
            <p>Doorbells only use 9 or 14 volts of electricity, so you don't need to turn off the electricity.</p>
            ...
            <div class="inst-container">  
                <p>Pound in the plastic anchors for stucco or brick.</p><img class="inst-img left" src="images/instructions/anchors.JPG" alt="pound in anchors">
            </div>
            <div class="inst-container">
            ...
            <div class="inst-container">
                <p>Put the button-back into the hole along with the excess wire and line up pilot holes you drilled for the wood screws or the anchors you put in for the stucco and screw in the screws. DO NOT OVER-TIGHTEN THE SCREWS!</p><img class="inst-img left" src="images/instructions/screw1.JPG" alt="screw into wall">
            </div>        
            <div class="inst-container">
