  ...
  <div class="container">
    <div class="row checkout-screen">
      <div class="col-sm-8 checkout-form">
        ...
        <form action="./src/Order.php" method="POST" onsubmit="openSubmitOrderModal()">
          <div class="row">
            <div class="col-sm-6">
          ...
          <div class="checkout-form-footer space-left space-right">
            ...
            <button type="submit" name="submit" id="checkout-btn" class="btn btn-primary-filled btn-rounded"><i
                class="lnr lnr-exit"></i><span>Checkout with Square</span></button>
      ...
      <div class="col-sm-4 checkout-total">
        ...
        <div class="cart-total-footer">
          <a href="shopping-cart.php" class="btn btn-default-filled btn-rounded"><i
              class="lnr lnr-arrow-left"></i><span>Back to Cart</span></a>
          <a href="./#categories" class="btn btn-primary-filled btn-rounded"><i class="lnr lnr-cart"></i><span>Back to
              Shop</span></a>
